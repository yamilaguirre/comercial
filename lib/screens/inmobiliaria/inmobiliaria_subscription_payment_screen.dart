...
class InmobiliariaSubscriptionPaymentScreen extends StatefulWidget {
  const InmobiliariaSubscriptionPaymentScreen({super.key});

  @override
  State<InmobiliariaSubscriptionPaymentScreen> createState() =>
      _InmobiliariaSubscriptionPaymentScreenState();
}

class _InmobiliariaSubscriptionPaymentScreenState
    extends State<InmobiliariaSubscriptionPaymentScreen> {
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text('Suscripción Inmobiliaria'),
