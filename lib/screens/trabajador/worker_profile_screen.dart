    ...
    return Scaffold(
      ...
      body: StreamBuilder<DocumentSnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          // Estadísticas simuladas (puedes obtenerlas de Firestore en el futuro)
          final ofertas = 12;
          final clientes = 8;
          final visitas = 2847;
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(
                              child: _buildStatCard(
                                'Visitas',
                                '${(visitas / 1000).toStringAsFixed(1)}K',
