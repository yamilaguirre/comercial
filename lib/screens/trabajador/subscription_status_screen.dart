    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          _buildBenefitCard(
            Icons.videocam,
            'Sube videos a tu portafolio',
            'Muestra tus trabajos con videos de hasta 30 segundos para destacar tus habilidades',
            Colors.purple,
          ),
          ...
          _buildBenefitCard(
            Icons.star,
            'Perfil destacado',
            'Tu perfil aparecerá primero en los resultados de búsqueda y tendrá mayor visibilidad',
            Colors.orange,
          ),
          const SizedBox(height: 32),
          SizedBox(
