      ...
      child: Column(
        children: [
          ...
          _buildBenefitCard(
            ...
            'Tus anuncios y cambios enviarán notificaciones push a todos los usuarios registrados de la app',
            Colors.orange,
          ),
          ...
          _buildBenefitCard(
            ...
            'Disfruta de una experiencia sin interrupciones ni publicidad de terceros',
            Colors.green,
          ),
          const SizedBox(height: 16),
          _buildBenefitCard(
            Icons.videocam,
            'Sube videos de tus propiedades',
            'Muestra tus propiedades con videos de alta calidad para atraer más clientes',
            Colors.purple,
          ),
          const SizedBox(height: 32),
          SizedBox(
