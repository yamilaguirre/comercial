...
import 'package:flutter_map/flutter_map.dart'; // Importante para el mapa
import 'dart:io';
...
class _PropertyFormScreenState extends State<PropertyFormScreen> {
  ...
  void initState() {
    ...
    if (widget.propertyToEdit != null) {
      _initializeForEdit(widget.propertyToEdit!);
    } else {
  ...
  Future<void> _selectLocationOnMap() async {
    ...
    // Abrimos el MapPickerScreen para selección fina
    final LatLng? result = await context.push('/map-picker', extra: extras);
    if (result != null) {
      setState(
