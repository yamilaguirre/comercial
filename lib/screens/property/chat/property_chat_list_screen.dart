...
class PropertyChatListScreen extends StatefulWidget {
  const PropertyChatListScreen({super.key});

  @override
  State<PropertyChatListScreen> createState() => _PropertyChatListScreenState();
}

class _PropertyChatListScreenState extends State<PropertyChatListScreen> {
